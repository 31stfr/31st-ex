        ...
        <div className="flex-1 flex flex-col justify-center items-center gap-8">
            ...
            <div className="flex items-center gap-8">
                <Link
                    ...
                    className="h-16 w-16 text-white text-3xl bg-neutral-500 hover:bg-neutral-400 rounded-xl flex justify-center items-center"
                >
                    <FaGithub />
                </Link>
                <Link
                    href="https://31st.fr"
                    className="h-16 w-16 text-white bg-neutral-500 hover:bg-neutral-400 rounded-xl flex justify-center items-center"
                >
                    31st.fr
                </Link>
            </div>
